...
function playRound(target) {
  ...
  if (computerChoice === playerChoice) {
    answer1.textContent = "It's a tie!";
    answer2.textContent = "You both chose " + computerChoice;
  } else if (
    (computerChoice === "Rock" && playerChoice === "Paper") ||
    (computerChoice === "Paper" && playerChoice === "Scissors") ||
    (computerChoice === "Scissors" && playerChoice === "Rock")
  ) {
    answer1.textContent = "You win!";
    answer2.textContent = playerChoice + " beats " + computerChoice;
    ...
    answer1.textContent = "You lose!";
    answer2.textContent = computerChoice + " beats " + playerChoice;
...
function game() {
  ...
  if (scorePlayer === 5 && scorePlayer > scoreComputer) {
    answer1.textContent = `You won the game!`;
    answer2.textContent = `You have ${scorePlayer} while the computer's are ${scoreComputer}`;
    gScorePlayer++;
    gameEnds();
  } else if (scoreComputer === 5 && scorePlayer < scoreComputer) {
    answer1.textContent = `You lost the game!`;
    answer2.textContent = `You have ${scorePlayer} points while the computer's are ${scoreComputer}`;
    gScoreComputer++;
    gameEnds();
  }
}
